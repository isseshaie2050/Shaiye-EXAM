...
const ENGLISH_2025_EXAM: Exam = {
  ...
  questions: [
    ...
    { id: 'eng-24', section: SectionType.LITERATURE, text: '24. ______ is a repetition of initial consonant sounds in order to create rhythm.', type: 'mcq', options: ['Alliteration', 'Rhyme', 'rhythm', 'Satire'], correctAnswer: 'Alliteration', marks: 1, topic: 'Literature', explanation: 'Repetition of initial sounds.' },
